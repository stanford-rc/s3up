...
INSTALL
    ...
    To build s3up you will need to have a version of Go installed.  Currently
    s3up is being compiled with 1.23.2.  Clone the s3up repository and run `go
    build` to compile for your machine:
